...
public class CarDealership
{
	...
	public static void main(String[] args)
	{
		...
		Car ourSweetCar = new Car(); 
			...
			String userInputA = sc.nextLine(); //captures user response and stores it at userInputA
		do
		{
	...
	public static boolean numberIsValid(String someStringToMakeNumber)
	{
		
		try
		{
			int aNumber = Integer.parseInt(someStringToMakeNumber);
			return false; 
